...
const ReportManagement = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [overallRes, weekExpRes, monthExpRes, weekSetRes, monthSetRes] = await Promise.all([
        ...
        <TabsContent value="overall" className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-3xl font-bold">{overall.totalPlans}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="flex items-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold">{overall.chosenCount}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="flex items-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold">{overall.expiredCount}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader className="flex items-center">
              ...
              <CardContent>
                <p className="text-3xl font-bold">{overall.rejectedCount}</p>
              </CardContent>
            </Card>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p>Total: {overall.totalPlans}</p>
                <p>INR: {overall.inrPlans}</p>
                <p>USDT: {overall.usdtPlans}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
              ...
              <CardContent>
                <p>Total: {overall.chosenCount}</p>
                <p>INR: {overall.chosenINR}</p>
                <p>USDT: {overall.chosenUSDT}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
              ...
              <CardContent>
                <p>Total: {overall.expiredCount}</p>
                <p>INR: {overall.expiredINR}</p>
                <p>USDT: {overall.expiredUSDT}</p>
              </CardContent>
            </Card>
            <Card className="shadow-lg hover:shadow-xl transition-shadow">
              <CardHeader>
              ...
              <CardContent>
                <p>Total: {overall.rejectedCount}</p>
                <p>INR: {overall.rejectedINR}</p>
                <p>USDT: {overall.rejectedUSDT}</p>
              </CardContent>
            </Card>
          </div>
          <Card className="shadow-lg hover:shadow-xl transition-shadow max-w-md mx-auto">
            <CardHeader>
              <CardTitle>Plan Wise Chosen Counts</CardTitle>
            </CardHeader>
            <CardContent>
              <ul className="space-y-2">
                <li>Starter: {overall.planWiseCounts?.starter || 0}</li>
                <li>Advanced: {overall.planWiseCounts?.advanced || 0}</li>
                <li>Premium: {overall.planWiseCounts?.premium || 0}</li>
                <li>Elite: {overall.planWiseCounts?.elite || 0}</li>
              </ul>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="weekly">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="shadow-lg">
              ...
              <CardContent>
                <p className="text-lg mb-4">
                  Total: {weekExpirations.count} | INR: ₹{weekExpirations.totalAmounts?.INR || 0} | USDT: {weekExpirations.totalAmounts?.USDT || 0}
                </p>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <p className="text-lg mb-4">
                  Total: {weekSettlements.count} | INR: ₹{weekSettlements.totalSettlementAmounts?.INR || 0} | USDT: {weekSettlements.totalSettlementAmounts?.USDT || 0}
                </p>
        ...
        <TabsContent value="monthly">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="shadow-lg">
              ...
              <CardContent>
                <p className="text-lg mb-4">
                  Total: {monthExpirations.count} | INR: ₹{monthExpirations.totalAmounts?.INR || 0} | USDT: {monthExpirations.totalAmounts?.USDT || 0}
                </p>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent>
                <p className="text-lg mb-4">
                  Total: {monthSettlements.count} | INR: ₹{monthSettlements.totalSettlementAmounts?.INR || 0} | USDT: {monthSettlements.totalSettlementAmounts?.USDT || 0}
                </p>
